...
namespace BankLoanApp.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BankerId = table.Column<string>(type: "text", nullable: false),
                    Note = table.Column<string>(type: "text", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BankerNotes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BankerNotes_AspNetUsers_BankerId",
                        column: x => x.BankerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BankerNotes_LoanApplications_LoanApplicationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LoanStatusHistories_AspNetUsers_ChangedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BankerNotes_BankerId",
                table: "BankerNotes",
                column: "BankerId");

            migrationBuilder.CreateIndex(
                name: "IX_BankerNotes_LoanApplicationId",
                table: "BankerNotes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LoanStatusHistories_ChangedById",
